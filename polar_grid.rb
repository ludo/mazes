    ...
    [:backgrounds, :walls].each do |mode|
      each_cell do |cell|
        ...
        if mode == :backgrounds
          ...
          img.polygon([ax, ay, cx, cy, dx, dy], color, color) if color
          img.polygon([ax, ay, bx, by, dx, dy], color, color) if color
          img.polygon([cx, cy, bx, by, dx, dy], color, color) if color
        else
